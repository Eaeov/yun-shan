package com.zyj.productservice.aspect;
...
public class AutoFillAspect {
    ...
    /*
      匹配 com.zyj.productservice.mapper 包下所有类的所有方法
      * 表示任意返回类型
      com.zyj.productservice.mapper.* 表示包下的所有类
      .*(..) 表示类中的所有方法，参数任意
     */
    @Pointcut("execution(* com.zyj.productservice.mapper.*.*(..)) && @annotation(com.zyj.productservice.annotation.AutoFill)")
    public void autoFillPointCut(){}


    @Around("autoFillPointCut()") // 环绕通知
