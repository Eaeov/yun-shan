package com.zyj.orderservice.aspect;


import com.sky.constant.AutoFillConstant;
import com.sky.context.BaseContext;
import com.sky.enumeration.OperationType;
import com.zyj.orderservice.annotation.AutoFill;
...
public class AutoFillAspect {
    ...
    /*
      ...
      * 表示任意返回类型
      ...
      .*(..) 表示类中的所有方法，参数任意
     */
    @Pointcut("execution(* com.zyj.orderservice.mapper.*.*(..)) && @annotation(com.zyj.orderservice.annotation.AutoFill)")
